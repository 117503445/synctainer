...
func TestConvertToNewImage(t *testing.T) {
	...
	cases := []struct {
		...
		{
			image:    "mysql",
			expected: "registry.cn-hangzhou.aliyuncs.com/117503445-mirror/docker.io.library.mysql:latest",
		}, {
			image:    "mysql:8.0",
			expected: "registry.cn-hangzhou.aliyuncs.com/117503445-mirror/docker.io.library.mysql:8.0",
		},
		{
			image:    "ghcr.io/devcontainers/features/anaconda:1",
			expected: "registry.cn-hangzhou.aliyuncs.com/117503445-mirror/ghcr.io.devcontainers.features/anaconda:1",
		},
		{
			image:    "ubuntu:18.04@sha256:98706f0f213dbd440021993a82d2f70451a73698315370ae8615cc468ac06624",
			expected: "registry.cn-hangzhou.aliyuncs.com/117503445-mirror/docker.io.library.ubuntu@sha256:98706f0f213dbd440021993a82d2f70451a73698315370ae8615cc468ac06624",
		},
	}
	for _, c := range cases {
